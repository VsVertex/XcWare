...
frame.Size = UDim2.new(0, 250, 0, 520)  -- Extended to fit everything
...
scroll.Size = UDim2.new(1, -10, 1, -310)  -- Adjusted for new bottom buttons
...
setBtn.Position = UDim2.new(0, 10, 1, -205)
setBtn.Text = "SET POS"
...
tpBtn.Position = UDim2.new(0.5, 2, 1, -205)
tpBtn.Text = "TP POS"
...
spawnBtn.Position = UDim2.new(0, 10, 1, -165)
...
removeSpawnBtn.Position = UDim2.new(0.5, 2, 1, -165)
...
speedToggle.Position = UDim2.new(0, 10, 1, -125)
...
speedInput.Position = UDim2.new(0.5, 2, 1, -125)
speedInput.Text = "100"
...
-- Auto Steal Bomb Button (manual, using your idea)
local autoStealBtn = Instance.new("TextButton")
autoStealBtn.Size = UDim2.new(1, -20, 0, 36)
autoStealBtn.Position = UDim2.new(0, 10, 1, -85)
autoStealBtn.Text = "STEAL BOMB"
autoStealBtn.Font = Enum.Font.GothamBold
autoStealBtn.TextSize = 14
autoStealBtn.BackgroundColor3 = Color3.fromRGB(180, 40, 40)
...
-- Loop TP Toggle (rectangle, flat, on the side - not too big)
local loopEnabled = false
local loopTarget = nil
local originalCFrame = nil

local loopToggle = Instance.new("TextButton")
loopToggle.Size = UDim2.new(0, 85, 0, 38)  -- rectangle, not too big
loopToggle.Position = UDim2.new(1, -95, 0.5, -19)  -- side of GUI
...
Instance.new("UICorner", loopToggle).CornerRadius = UDim.new(0, 4)  -- flat look
...
-- Auto Steal Bomb (manual, using your idea)
