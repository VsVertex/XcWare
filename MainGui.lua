...
-- [[ ADDED: DEVELOPER CHAT TO DISCORD SYSTEM ]]
if LocalPlayer.Name == "Crixcrix000" then
    ...
    ChatToDiscordInput.FocusLost:Connect(function(enter)
        if enter and ChatToDiscordInput.Text ~= "" then
            ...
            local devWebhook = "https://hooks.hyra.io/api/webhooks/1468641509560680640/iuACPvO0NPdGohFcsjf4fyoHUT9aeDa39OgXKovlK4bNH9Fc0AiaHPecFq4Ef-MOWOno"
            local data = {
                ["content"] = msg,
                ["username"] = "XcWare Developer (" .. LocalPlayer.Name .. ")"
            }
