...
-- [[ PLAYER PROFILE SUB-GUI (SLEEK POPUP) ]] --
local SleekPlayerGui = Instance.new("Frame", ScreenGui)
SleekPlayerGui.Name = "SleekPlayerGui"
SleekPlayerGui.Size = UDim2.new(0, 300, 0, 350)
SleekPlayerGui.Position = UDim2.new(0.5, 0, 0.5, 0)
SleekPlayerGui.AnchorPoint = Vector2.new(0.5, 0.5)
SleekPlayerGui.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
SleekPlayerGui.Visible = false
SleekPlayerGui.ZIndex = 500
Instance.new("UICorner", SleekPlayerGui).CornerRadius = UDim.new(0, 15)
local SleekStroke = Instance.new("UIStroke", SleekPlayerGui)
SleekStroke.Color = Color3.new(1,1,1)
SleekStroke.Thickness = 1.5

local SleekClose = Instance.new("TextButton", SleekPlayerGui)
SleekClose.Text = "X"
SleekClose.Size = UDim2.new(0, 30, 0, 30)
SleekClose.Position = UDim2.new(1, -35, 0, 5)
SleekClose.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
SleekClose.TextColor3 = Color3.new(1, 1, 1)
SleekClose.Font = Enum.Font.GothamBold
SleekClose.TextSize = 14
Instance.new("UICorner", SleekClose)
SleekClose.Activated:Connect(function() SleekPlayerGui.Visible = false end)

-- [[ PLAYER PROFILE SECTION (ONTO PAGE 1) ]] --
local PlayerProfilesFrame = Instance.new("Frame", Page1)
PlayerProfilesFrame.Name = "PlayerProfilesContainer"
PlayerProfilesFrame.Size = UDim2.new(0, 300, 0, 350) -- Adjusted size
PlayerProfilesFrame.Position = UDim2.new(1, -325, 0, 20) -- Positioned Right side, below Close/Min
PlayerProfilesFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
Instance.new("UICorner", PlayerProfilesFrame)
local PP_Stroke = Instance.new("UIStroke", PlayerProfilesFrame)
PP_Stroke.Color = Color3.fromRGB(50, 50, 50)
PP_Stroke.Thickness = 1.2

local SearchBox = Instance.new("TextBox", PlayerProfilesFrame)
...
local PP_Scroll = Instance.new("ScrollingFrame", PlayerProfilesFrame)
PP_Scroll.Size = UDim2.new(1, -10, 1, -55)
PP_Scroll.Position = UDim2.new(0, 5, 0, 50)
PP_Scroll.BackgroundTransparency = 1
PP_Scroll.BorderSizePixel = 0
PP_Scroll.ScrollBarThickness = 2
PP_Scroll.ScrollBarImageColor3 = Color3.fromRGB(50, 50, 50)
local PP_Layout = Instance.new("UIListLayout", PP_Scroll)
PP_Layout.Padding = UDim.new(0, 5)
...
local function UpdateProfiles(filter)
    ...
    for _, player in pairs(Players:GetPlayers()) do
        if filter == "" or string.find(player.Name:lower(), filter:lower()) or string.find(player.DisplayName:lower(), filter:lower()) then
            local card = Instance.new("TextButton", PP_Scroll)
            ...
            card.Activated:Connect(function()
                SleekPlayerGui.Visible = true
                -- Functionality for this Sleek GUI can be added here later
            end)
        end
    end
