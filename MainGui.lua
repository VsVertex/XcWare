...
-- [[ MODIFIED: PLAYER PROFILES UPDATED ]] --
local SidebarProfiles = Instance.new("CanvasGroup", ScreenGui)
SidebarProfiles.Name = "SidebarProfiles"
SidebarProfiles.Size = UDim2.new(0, 210, 0, 320) -- Made smaller
SidebarProfiles.BackgroundColor3 = Color3.fromRGB(5, 5, 5)
SidebarProfiles.BorderSizePixel = 0
SidebarProfiles.Visible = false -- Start hidden
Instance.new("UICorner", SidebarProfiles).CornerRadius = UDim.new(0, 12)
local SideStroke = Instance.new("UIStroke", SidebarProfiles)
SideStroke.Color = Color3.fromRGB(40, 40, 40)
SideStroke.Thickness = 1.5

local SideTitle = Instance.new("TextLabel", SidebarProfiles)
SideTitle.Size = UDim2.new(1, 0, 0, 40)
SideTitle.Text = "PLAYERS"
SideTitle.TextColor3 = Color3.new(1, 1, 1)
SideTitle.Font = Enum.Font.GothamBold
SideTitle.TextSize = 13
SideTitle.BackgroundTransparency = 1

-- NEW: CLOSE BUTTON ON PROFILES
local ProfileClose = Instance.new("TextButton", SidebarProfiles)
ProfileClose.Text = "X"
...
PP_Scroll.Size = UDim2.new(1, -15, 1, -80)
PP_Scroll.Position = UDim2.new(0, 5, 0, 75)
...
PP_Layout.Padding = UDim.new(0, 6)

-- Function to keep Sidebar pinned to the Right side of MainFrame when visible
RunService.RenderStepped:Connect(function()
    if MainFrame.Visible and SidebarProfiles.Visible then
        SidebarProfiles.GroupTransparency = MainFrame.GroupTransparency
        local mainPos = MainFrame.AbsolutePosition
        local mainSize = MainFrame.AbsoluteSize
        SidebarProfiles.Position = UDim2.new(0, mainPos.X + mainSize.X + 10, 0, mainPos.Y + (mainSize.Y/2) - (SidebarProfiles.Size.Y.Offset/2))
