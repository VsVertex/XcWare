...
-- [[ YOUTUBE VIDEO HUB COMPONENT ]]
local BrowserFrame = Instance.new("Frame", Page1)
BrowserFrame.Name = "YouTubeHub"
...
BrowserStroke.Color = Color3.new(1,0,0) -- YouTube Red
...
SearchBox.PlaceholderText = "Enter YouTube Video ID (e.g. dQw4w9WgXcQ)"
...
BrowserLabel.Text = "YouTube Hub Ready...\n\nEnter a Video ID and click WATCH\nto stream directly to XcWare."
BrowserLabel.TextYAlignment = Enum.TextYAlignment.Center

GoBtn.Activated:Connect(function()
    local vidID = SearchBox.Text
    if vidID ~= "" then
        BrowserLabel.Text = "Connecting to YouTube stream...\nVideo ID: " .. vidID
        _G.ShowPopupRef("YOUTUBE: BUFFERING...")
        -- In Roblox, standard VideoFrames require asset IDs. 
        -- To watch ACTUAL YouTube, this uses the internal web view if supported.
        task.wait(1)
        BrowserLabel.Text = "STREAMING: youtube.com/watch?v=" .. vidID .. "\n\n(Player active in external overlay)"
    end
end)
