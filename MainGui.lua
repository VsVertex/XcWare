...
-- [[ MODIFIED: PLAYER PROFILES MOVED OUTSIDE ON THE RIGHT ]] --
local SidebarProfiles = Instance.new("CanvasGroup", ScreenGui)
SidebarProfiles.Name = "SidebarProfiles"
SidebarProfiles.Size = UDim2.new(0, 230, 0, 480)
...
PP_Scroll.Size = UDim2.new(1, -15, 1, -85)
PP_Scroll.Position = UDim2.new(0, 5, 0, 80)
PP_Scroll.BackgroundTransparency = 1
PP_Scroll.BorderSizePixel = 0
PP_Scroll.ScrollBarThickness = 3
...
-- Function to keep Sidebar pinned to the Right side of MainFrame
RunService.RenderStepped:Connect(function()
    if MainFrame.Visible then
        SidebarProfiles.Visible = true
...
local function UpdateProfiles(filter)
    -- FIX: Clear existing cards to prevent duplication
