...
_G.HandleCommand = function(msg)
    ...
    elseif command == "-unspin" then
        local humRoot = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("XcWare_Spin") then
...
-- [[ INTEGRATED: PLAYER PROFILES MODIFIED TO TOP OF PAGE 1 ]] --
local SidebarProfiles = Instance.new("Frame", Page1)
SidebarProfiles.Name = "SidebarProfiles"
SidebarProfiles.Size = UDim2.new(1, 0, 0, 120) -- Long horizontal bar
SidebarProfiles.Position = UDim2.new(0, 0, 0, 0) -- Top under topbar
SidebarProfiles.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
SidebarProfiles.BorderSizePixel = 0
SidebarProfiles.ClipsDescendants = true
Instance.new("UIStroke", SidebarProfiles).Color = Color3.fromRGB(30, 30, 30)

local ProfileHeader = Instance.new("Frame", SidebarProfiles)
ProfileHeader.Size = UDim2.new(1, 0, 0, 25)
...
SideTitle.Text = "ACTIVE PLAYERS"
SideTitle.TextColor3 = Color3.new(0.6, 0.6, 0.6)
...
PP_Scroll.Size = UDim2.new(1, -20, 1, -35)
PP_Scroll.Position = UDim2.new(0, 10, 0, 30)
...
PP_Scroll.ScrollingDirection = Enum.ScrollingDirection.X -- LEFT TO RIGHT SCROLLING

local PP_Layout = Instance.new("UIListLayout", PP_Scroll)
PP_Layout.Padding = UDim.new(0, 12)
PP_Layout.FillDirection = Enum.FillDirection.Horizontal
PP_Layout.VerticalAlignment = Enum.VerticalAlignment.Center
...
local function UpdateProfiles()
    ...
    for _, player in pairs(Players:GetPlayers()) do
        ...
        card.Size = UDim2.new(0, 160, 0, 75)
        ...
        name.Position = UDim2.new(0, 55, 0, 20)
        ...
        user.Size = UDim2.new(1, -60, 0, 14)
        user.Position = UDim2.new(0, 55, 0, 38)
        ...
        card.MouseLeave:Connect(function()
            TweenService:Create(card, iOS_Out, {BackgroundColor3 = Color3.fromRGB(12, 12, 12)}):Play()
            TweenService:Create(s, iOS_Out, {Color = Color3.fromRGB(35, 35, 35)}):Play()
        end)
    end
    PP_Scroll.CanvasSize = UDim2.new(0, PP_Layout.AbsoluteContentSize.X + 20, 0, 0)
end

Players.PlayerAdded:Connect(UpdateProfiles)
Players.PlayerRemoving:Connect(UpdateProfiles)
UpdateProfiles()
