...
IMPORTANT: For technical things needing code (fly, swim, speed, jump power, teleport, noclip, esp, aimbot, infinite jump, god mode, kill aura, auto farm, or anything with scripts/hacks/executors), reply with EXACTLY this and nothing else:
...
local CMDS={{"── AI ──",true},{"!ask <message> - talk to XcH",false},{"!gameinfo - what game is this",false},{"!gameinfo full - everything about it",false},{"!gameinfo tips - how to get good",false},{"!gameinfo controls - keybinds",false},{"!gameinfo wiki - best resources",false},{"!similar - games like this one",false},{"!backoff <n> | !getcloser <n>",false},{"!orbit <1-1000> | !unorbit",false},{"!lead <player> | !unlead",false},{"!sit | !stand | !jump",false},{"!hide | !spawn",false},{"!bam <player> | !unbam",false},{"!annoy <player> | !unannoy",false},{"!fling <player> | !unfling",false},{"!swordkill <player> | !unswordkill",false},{"!dance 1-4 | !undance",false},{"!spin 1-100 | !unspin",false},{"!math <num><op><num>",false},{"!say <text>",false},{"!cmds",false}}
